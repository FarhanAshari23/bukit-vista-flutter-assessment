...
class EdwardPage extends StatefulWidget {
  const EdwardPage({Key? key}) : super(key: key);

  @override
  State<EdwardPage> createState() => _EdwardPageState();
}

class _EdwardPageState extends State<EdwardPage> {
  late int index;
  @override
  void initState() {
    index = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          profile(4, 'assets/man.png', 'Edward Beckham', 'London'),
          SizedBox(height: bodyHeight * 0.04),
          fullProfile(
              '11 Januari 1993',
              'wardbeckham@gmail.com',
              '+44-20-7946-0625',
              'PR0678',
              '5 June 2021, 2:00 PM',
              '8 June 2021, TBA',
