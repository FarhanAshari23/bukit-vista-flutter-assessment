...
class LucyPage extends StatefulWidget {
  const LucyPage({Key? key}) : super(key: key);

  @override
  State<LucyPage> createState() => _LucyPageState();
}

class _LucyPageState extends State<LucyPage> {
  late int index;
  @override
  void initState() {
    index = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          profile(2, 'assets/woman.png', 'Lucy Anna', 'Singapore'),
