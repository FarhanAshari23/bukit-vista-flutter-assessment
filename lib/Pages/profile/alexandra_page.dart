...
class AlexandraPage extends StatefulWidget {
  const AlexandraPage({Key? key}) : super(key: key);

  @override
  State<AlexandraPage> createState() => _AlexandraPageState();
}

class _AlexandraPageState extends State<AlexandraPage> {
  late int index;
  @override
  void initState() {
    index = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          profile(3, 'assets/woman.png', 'Alexandra Morgan', 'Australia'),
