...
class Property4 extends StatefulWidget {
  const Property4({Key? key}) : super(key: key);

  @override
  State<Property4> createState() => _Property4State();
}

class _Property4State extends State<Property4> {
  late int index;
  @override
  void initState() {
    index = 0;
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          fullProperty('ATRA BAMBULOGY', 'PR0497', 'Rp.670.000/night', '1', '2',
              '1', '4')
        ],
      ),
