...
class Property3 extends StatefulWidget {
  const Property3({Key? key}) : super(key: key);

  @override
  State<Property3> createState() => _Property3State();
}

class _Property3State extends State<Property3> {
  late int index;
  @override
  void initState() {
    index = 0;
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          fullProperty('LUXURIOUS HOME', 'PR0616', 'Rp.1.880.000/night', '3',
              '3', '3', '6')
        ],
      ),
