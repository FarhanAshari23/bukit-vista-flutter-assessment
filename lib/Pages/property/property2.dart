...
class Property2 extends StatefulWidget {
  const Property2({Key? key}) : super(key: key);

  @override
  State<Property2> createState() => _Property2State();
}

class _Property2State extends State<Property2> {
  late int index;
  @override
  void initState() {
    index = 0;
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          fullProperty('SPACIOUS WOODEN VILLA', 'PR0703', 'Rp.3.620.000/night',
              '5', '5', '2', '10')
        ],
      ),
